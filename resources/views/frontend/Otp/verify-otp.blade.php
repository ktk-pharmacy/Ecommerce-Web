      ...
      <div class="row">
         <div class="col-lg-6 offset-lg-3">
            ...
            <div class="account-login-inner">
               <form action="{{ route('frontend.verifyOtp') }}" method="POST" class="customer-otp-form ltn__form-box contact-form-box">
                  @csrf
                  <input type="hidden" name="username" placeholder="Email or Phone*" value="{{ $data->username }}" required>
