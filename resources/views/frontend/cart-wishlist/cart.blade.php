            ...
            <div class="shoping-cart-inner">
                              ...
                              <tr>
                                 ...
                                 <td class="cart-product-info" style="width: 100%;">
                                    <h4>
                                       <a href="{{ route('frontend.products.detail', $product['slug']) }}">
                                          {{ $product['name'] }}
                                       </a>@if ($product['stock'] == 0)
                                       / <small>(<span class="text-danger">This item is currently out of stock !!</span>)</small>
                                       @elseif ($product['cart_quantity']>$product['stock'])
                                       / <small>(<span class="text-danger">We have only {{ $product['stock'] }}stock of this item !!</span>)</small>
                                       @endif
                                    </h4>
                                 ...
                                 <td class="cart-product-quantity">
                                    <div class="cart-plus-minus">
                                       <input type="text" value="{{ $product['cart_quantity'] }}" name="cart_products[{{$product['id']}}][quantity]" class="cart-plus-minus-box">
                                    </div>
                                 </td>
               ...
               <div style="max-width: 450px;" class="shoping-cart-total mt-50">
                  ...
                  <table class="table">
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><strong>MMK{{ $cart['subtotal'] }}</strong></td>
                        </tr>
                ...
                <div class="btn-wrapper text-right">
                    <a href="{{ route('frontend.checkout') }}" class="theme-btn-1 btn btn-effect-1">Proceed to checkout</a>
                </div>
               </div>
            </div>
         </div>
...
<div class="ltn__call-to-action-area no-cart-action-area call-to-action-6 before-bg-bottom {{ count($cart['products']) ? 'd-none' : '' }}" data-bs-bg="img/1.jpg--">
   <div class="container">
      <div class="row">
         <div class="col-lg-12">
