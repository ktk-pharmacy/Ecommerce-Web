            ...
            <div class="col-lg-8 order-lg-2 mb-120">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="showing-product-number text-right">
                                <span>Showing {{$products->currentPage()}}-{{$products->total()}} of {{$products->count()}} results</span>
                            </div>
                        </li>
                        <li>
                    ...
                    <div class="tab-pane fade active show" id="liton_product_grid">
                        <div class="ltn__product-tab-content-inner ltn__product-grid-view">
                            <div class="row product-grid">
                                ...
                                <div style="" class="col-xl-4 col-sm-6 col-6 p-grid-item " data-product-id="{{ $product->id }}" data-product-price="{{ $product->discount ?? $product->sale_price }}">
                                    <div class="ltn__product-item  text-center">
                                        <div class="product-img ">
                                            <a href="{{ route('frontend.products.detail', $product->slug) }}"><img src="{{$product->feature_image}}" alt="#"></a>
                                        ...
                                        <div class="product-info">
                                            ...
                                            <h2 class="product-title"><a href="{{ route('frontend.products.detail', $product->slug) }}">{{ $product->name }}</a>
                                                @if ($product->stock == 0)
                                                <div><small class="text-danger">{{ $product->name }} is currently out of stock !!</small></div>
                                            @endif</h2>
                    ...
                    <div class="tab-pane fade" id="liton_product_list">
                        <div class="ltn__product-tab-content-inner ltn__product-list-view">
                            <div class="row product-list">
                                <!-- ltn__product-item -->
                                @foreach ($products as $product)
                                <div class="col-lg-12 p-list-item" data-product-id="{{ $product->id }}" data-product-price="{{ $product->discount ?? $product->sale_price }}">
                                    <div class="ltn__product-item ltn__product-item-3">
                                        ...
                                        <div class="product-info">
                                            <h2 class="product-title"><a href="{{ route('frontend.products.detail', $product->slug) }}">{{ $product->name }}</a></h2>
                                            <div class="product-ratting">
                                                <ul>
                                                    <li><a href="#"><i class="fas fa-star"></i></a></li>
                                                    <li><a href="#"><i class="fas fa-star"></i></a></li>
                                            ...
                                            <div class="product-brief">
                                                <a href="{{ route('frontend.products.detail', $product->slug) }}">
                                                    <p>{{ Str::words( strip_tags($product->description), 13,'....') }}</p>
                                                </a>
                                            </div>
                ...
                <div class="ltn__pagination-area text-center">
                    <div class="ltn__pagination">
                        @include('frontend.layouts.shared.pagination', ['paginator' => $products, $products->links(), 'link_limit' => 4])
                    </div>
                </div>
            </div>
                                    ...
                                    <ul>
                                        <li><a href="#">{{ $main_category->name }} </a>
                                            @foreach ($main_category->childs as $sub_category)
                                                <ul class="sub-menu">
                                                    <li><a href="{{ route('frontend.products.index').'?category='.$sub_category->id }}">- - {{ $sub_category->name }}</a></li>
                                                </ul>
                                            @endforeach
                                        </li>
                                    </ul>
                        ...
                        <div class="price_filter row">
                            <div class="col-9 pt-1">
                                <div class="price_slider_amount">
                                    ...
                                    <input form="product-filter-form" type="text" class="amount" name="price"  placeholder="Add Your Price" />
                                </div>
                            ...
                            <div class="col-3">
                                <div class="btn-wrapper pt-lg-5">
                                    <form action="{{ route('frontend.products.index') }}" id="product-filter-form">
                                        <button class="theme-btn-1 w-100 float-end btn py-1 px-2 rounded-1 btn-effect-1" type="submit">Filter</button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    function sortByPrice(selector, appendTo, sortBy) {
        ...
        .sort((a,b) => {
            if (sortBy == 'price-desc') {
                if ($(a).data("product-price") < $(b).data("product-price")) { return -1; }
            } else if(sortBy == 'price-asc') {
                if ($(a).data("product-price") > $(b).data("product-price")) { return -1; }
            } else {
                if ($(a).data("product-id") > $(b).data("product-id")) { return -1; }
            }
