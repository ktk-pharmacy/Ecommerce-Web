                  ...
                  <div class="col-md-5 offset-md-1 col-lg-6 offset-lg-0">
                     <div class="modal-product-info shop-details-info pl-0">
                        ...
                        <div class="modal-product-meta ltn__product-details-menu-1">
                           <ul>
                              <li>
                                 ...
                                 <span>
                                    <a href="javascript:void();">{{ $product->sub_category?->parent?->group?->name }}</a>
                                    <a href="javascript:void();">{{ $product->sub_category?->parent?->name }}</a>
                                    <a href="{{ route('frontend.products.index').'?category='.$product->sub_category?->id }}">
                        ...
                        <div class="ltn__safe-checkout">
                           ...
                           <div class="payment">
                                <img class="" src="{{asset('assets/theme/img/icons/visa_icon.png')}}" alt="#">
                                <img class="" src="{{asset('assets/theme/img/icons/mastercard_icon.png')}}" alt="#">
                                <img class="" src="{{asset('assets/theme/img/icons/jcb_icon (1).png')}}" alt="#">
                                <img class="" src="{{asset('assets/theme/img/icons/mpu.jpg')}}" alt="#">
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <li>
                           <div class="top-rated-product-item clearfix">
                              <div class="top-rated-product-img">
                                 <a href="{{ route('frontend.products.detail', $top_related_product->slug) }}">
                  ...
                  <div style="overflow: visible !important;" class="product-img">
                     ...
                     <div class="product-badge text-start">
                        ...
                        <div class="product-hover-action">
                            ...
                            <li>
                                <a
                                    href="{{ customerAuth() ? 'javascript:void(0);' : route('frontend.login').'?redirect='.url()->full() }}" title="Wishlist"
                                    onclick="{{ customerAuth() ? 'addToWishlist(this)' : '' }}"
                  ...
                  <div class="product-info">
                     ...
                     <h2 class="product-title">
                        ...
                        @if ($related_product->stock == 0)
                            <div><small class="text-danger">{{ $related_product->name }} is currently out of stock !!</small></div>
                        @endif
                     </h2>
                     <div class="product-price">
