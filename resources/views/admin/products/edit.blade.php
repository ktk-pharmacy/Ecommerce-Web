...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <form class="parsley-examples" action="{{ route('admin.products.update', $product->id) }}" method="post"
                    ...
                    <div class="card-box">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="name" id="product-name" class="form-control"
                                value="{{ $product->name }}" placeholder="e.g : Apple iMac" autofocus required>
                        </div>
                                ...
                                @foreach ($main_categories as $main_category)
                                    <optgroup label="{{ $main_category->name }}">
                                        @foreach ($main_category->childs as $sub_category)
                                            <option value="{{ $sub_category->id }}" @selected($product->category_id == $sub_category->id)>
                                                {{ $sub_category->name }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="price" min="1" value="{{ $product->price }}"
                                        class="form-control" id="product-price" step=".01" placeholder="Enter amount"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input data-parsley-gte="#product-price"
                                        ...
                                        step=".01" min="1" class="form-control" id="product-sale-price"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="discount_amount" class="form-control"
                                        value="{{ $product->discount_amount }}" id="discount-amount"
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="discount_period" id="range-datepicker-input"
                                        class="form-control" placeholder="2022-10-01 to 2022-10-10"
                                        value="{{ $product->discount_from . ' to ' . $product->discount_to }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control summernote" name="detail" id="product-detail" rows="5"
                                placeholder="Please enter detail">{{ $product->detail }}</textarea>
                        </div>
                    </div> <!-- end card-box -->
                </div> <!-- end col -->
                    ...
                    <div class="card-box">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" name="uom" class="form-control" id="product-uom"
                                            placeholder="Enter UOM" value="{{ $product->uom }}"
                                            {{ auth()->user()->can('product-stock-weight-edit')? '': 'readonly' }}
                                            required>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-0">
                                    ...
                                    <input type="checkbox" name="is_new" class="switchery" id="product-meta-new"
                                        value="1" @checked($product->is_new) />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-row">
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" name="net_weight" value="{{ $product->net_weight }}"
                                            class="form-control" id="product-net-weight"
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" name="gross_weight" value="{{ $product->gross_weight }}"
                                            class="form-control" id="product-gross-weight"
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="sell_limit" class="form-control" id="product-sell-limit"
                                        value="{{ $product->sell_limit }}" placeholder="Enter Sell Limit">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control summernote" name="other_information" id="orther-information" rows="5"
                                placeholder="Please enter other information">{{ $product->other_information }}</textarea>
                        </div>
                    </div> <!-- end col-->
    ...
    <script>
        $(document).ready(function() {
            ...
            $.each(galleries, function(key, v) {
                ...
                previewConfig.push({
                    frameClass: image_media_id_class,
                    downloadUrl: v.image_url,
                    key: key
                });
            });
            ...
            $.each(galleries, function(key, v) {
                ...
                var html =
                    '<a class="kv-file-remove btn btn-sm btn-kv btn-default btn-outline-secondary" data-id="' +
                    image_media_id +
                    '"data-url="' + image_media_delete_url +
            ...
            $("#range-datepicker-input").flatpickr({
                mode: "range",
                dateFormat: "Y-m-d",
                defaultDate: arr
            });
