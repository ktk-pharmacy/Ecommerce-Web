@extends('admin.layouts.master', ['title' => 'Edit Blog'])
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form class="parsley-examples" action="{{ route('admin.blogs.update', $post->id) }}" method="post" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
                    <div class="card-box">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" id="title" class="form-control" placeholder="e.g : Apple iMac" value="{{ $post->name }}" autofocus required>
                                </div>
                            </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control select2" name="terms[]" id="blog-category" multiple required>
                                        ...
                                        @foreach ($terms as $term)
                                            <option
                                                value="{{ $term->id }}"
                                                {{ $post->terms->contains('id', $term->id) ? 'selected':''}}
                                            >
                                                {{ $term->name }}
                                            </option>
                                        @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" name="description" id="description" rows="5" placeholder="Please enter description" required>{{ $post->description }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input
                                        ...
                                        data-default-file="{{ $post->feature_image }}"
                                ...
                                <div class="checkbox checkbox-success checkbox-circle mb-2">
                                    <input id="blog-status" type="checkbox" name="status" value="1" {{ $post->status ? 'checked' : '' }}>
