@extends('admin.layouts.master', ['title' => 'Edit Logistic'])
...
<div class="container-fluid">
         ...
         <div class="page-title-box">
            <div class="page-title-right">
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item active">Edit Logistic</li>
               </ol>
            </div>
            <h4 class="page-title">Edit Logistic</h4>
         </div>
      </div>
   </div>
   <!-- end page title -->
   ...
   <div class="row">
      <div class="col-6">
         <div class="card">
            <div class="card-body">
               <form class="parsley-examples" action="{{ route('admin.logistics.update', $logistic->id) }}" method="post">
                  @method('patch')
                  @csrf
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <div class="form-group">
                           ...
                           <textarea name="area_description" rows="5" parsley-trigger="change" required class="form-control"
