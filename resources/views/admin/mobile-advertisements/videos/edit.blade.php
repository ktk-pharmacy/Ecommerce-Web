...
<div class="container-fluid">
   ...
   <!-- end page title -->
   <form class="parsley-examples" action="{{ route('admin.mobile-ads.update', ['video', $ads->id]) }}" method="post"
         ...
         <div class="col-lg-6">
            ...
            <div class="card-box">
               ...
               <input
                  ...
                  name="video"
                  id="video"
                  data-max-file-size="7M"
                  data-allowed-file-extensions='["mp4","mov","ogg"]'
                  data-default-file="{{ $ads->video_url }}">
