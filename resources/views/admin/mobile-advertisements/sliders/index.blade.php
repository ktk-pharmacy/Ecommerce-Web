      ...
      <div class="col-12">
         <div class="card">
            <div class="card-body">
               ...
               <a href="{{ route('admin.mobile-ads.create', 'slider') }}">
                     ...
                     <tr>
                        ...
                        <td>
                           <img class="default-lazy" src="{{ asset('assets/images/loading.gif') }}"
                              data-src="{{ $slider->image_url }}" width="50">
                        </td>
                        <td>{{ $slider->sorting }}</td>
                        <td>
                           <div class="custom-control custom-switch">
                              <input type="checkbox" name="status"
                                 data-url="{{ route('admin.mobile-ads.update.status', ['slider', $slider->id]) }}"
                        ...
                        <td>
                           ...
                           <a class="action-icon editads" href="{{ route('admin.mobile-ads.edit', ['slider', $slider->id]) }}">
                              <i class="mdi mdi-square-edit-outline"></i>
                           </a>
                           @endcan
                           @can('ads-sidebar-delete')
                           <a href="javascript:void(0);" class="action-icon" data-toggle="modal" data-target="#deleteFormModal"
                              data-id="{{ $slider->id }}" data-url="{{ route('admin.mobile-ads.destroy', ['slider', $slider->id]) }} ">
