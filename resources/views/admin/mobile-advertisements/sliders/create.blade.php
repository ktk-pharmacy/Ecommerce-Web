...
<div class="container-fluid">
   ...
   <!-- end page title -->
   <form class="parsley-examples" action="{{ route('admin.mobile-ads.store', 'slider') }}" method="post" enctype="multipart/form-data">
      @csrf
      @if ($errors->any())
      ...
      <div class="row">
         ...
         <div class="col-lg-6">
            ...
            <div class="card-box">
               ...
               <input type="file" name="image" id="image" data-max-file-size="500K" data-max-width="1500" data-max-height="1000"
                  data-allowed-formats="landscape" data-allowed-file-extensions='["png", "PNG", "jpg", "JPG", "jpeg", "JPEG"]'
                  required>
