...
<div class="container-fluid">
   ...
   <!-- end page title -->
   <form class="parsley-examples" action="{{ route('admin.ads.store', 'slider') }}" method="post" enctype="multipart/form-data">
      @csrf
      @if ($errors->any())
         ...
         <div class="col-lg-6">
            <div class="card-box">
               ...
               <div class="form-group mb-3">
                  ...
                  <input type="text" name="slider_text1" id="slider-text-1" class="form-control">
               </div>

               <div class="form-group mb-3">
                  <label for="slider-text-2">Text 2 <span class="text-danger">*</span></label>
                  <input type="text" name="slider_text2" id="slider-text-2" class="form-control" required>
               </div>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group mb-3">
                        ...
                        <input type="text" name="link" class="form-control" id="go-to-link"
                  ...
                  <div class="col-md-6">
                     <div class="form-group mb-3">
                        ...
                        <input type="text" name="btn_txt" class="form-control" id="slider-btn-txt" placeholder="e.g : Shop now">
                     </div>
                  </div>
               </div>
         ...
         <div class="col-lg-6">
            ...
            <div class="card-box">
               ...
               <input
                  ...
                  required
               >
               <p class="sub-header mt-2">file size is under 500KB, max Width x Height is 1408 X 993 and Landscape only</p>
