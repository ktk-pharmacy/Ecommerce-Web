...
<body class="authentication-bg" style="background-color: black;">
               ...
               <div class="text-center">
                  <h2>
                     <a href="{{route('frontend.home')}}">
                        <img src="{{asset('assets/theme/img/orginal2.png')}}" alt="main-logo" height="100" />
                     </a>
                  </h2>
                  ...
                  <div class="row justify-content-center">
                     <div class="col-md-6">
                        <h4 class="mt-4 text-white">Now Available On</h4>
                        <a href="{{ config('custom_value.application.android.url') }}" target="_blank" type="button"
                           class="btn btn-danger waves-effect waves-light mr-3">
                           <i class="mdi mdi-android me-1"></i>
                           Download for Android
                        </a>
                        <a href="{{ config('custom_value.application.ios.url') }}" target="_blank" type="button"
                           class="btn btn-danger waves-effect waves-light">
                           <i class="mdi mdi-apple-ios me-1"></i>
                           Download for iOS
                        </a>
                     </div>
                  </div>
                  <div class="row mt-5 justify-content-center">
                     <div class="col-md-8">
                        <div data-countdown="2022/12/01" class="counter-number"></div>
                     </div> <!-- end col-->
                  </div> <!-- end row-->
               </div> <!-- end /.text-center-->
