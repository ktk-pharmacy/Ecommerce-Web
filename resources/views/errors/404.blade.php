...
<html lang="en">
    ...
    <head>
        @include('admin.layouts.shared.title-meta', ['title' => "Error Page | 404 | Page not Found"])
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Return to <a href="{{ route('frontend.home') }}" class="text-white ml-1"><b>Home</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
