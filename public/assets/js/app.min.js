        ...
        (LeftSidebar.prototype.initMenu = function () {
            ...
            if ($("#side-menu").length) {
                ...
                $("#side-menu a").each(function () {
                    // var pageUrl = window.location.href.split(/[?#]/)[0];     /* edited by tayzar */
                    var pageUrl = window.location.href.replace("?", "/");
                    let splitIndex = 5;
                    if (pageUrl.indexOf("ads") != -1) {
                        splitIndex = 6;
                    }
                    pageUrl = pageUrl.split("/", splitIndex).join("/");
    ...
    (function ($) {
        ...
        (RightBar.prototype.selectOptionsFromConfig = function () {
            ...
            if (config) {
                ...
                $(
                    "input[type=radio][name=width][value=" + config.width + "]"
                ).prop("checked", true);
                $(
            ...
            (RightBar.prototype.init = function () {
                ...
                $("input[type=radio][name=color-scheme-mode]").change(
                    function () {
                ...
                // left sidebar color
                $("input[type=radio][name=leftsidebar-color]").change(
                    function () {
                ...
                // left sidebar size
                $("input[type=radio][name=leftsidebar-size]").change(
                    function () {
                ...
                $("input[type=checkbox][name=leftsidebar-user]").change(
                    function (e) {
            ...
            (LayoutThemeApp.prototype.changeMode = function (mode) {
                ...
                switch (mode) {
                    case "dark": {
                        ...
                        this._saveConfig({
                            mode: mode,
                            sidebar: $.extend({}, this.config.sidebar, {
                                color: "dark",
                            }),
                        });
                        break;
